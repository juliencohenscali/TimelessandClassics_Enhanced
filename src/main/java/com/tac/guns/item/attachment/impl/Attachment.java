...
public abstract class Attachment
{
    ...
    private static void addPerk(List<ITextComponent> components, String id, TextFormatting format, Object... params)
    {
        components.add(new TranslationTextComponent("perk.tac.entry.negative", new TranslationTextComponent(id, params).mergeStyle(format)));
    }
}
